...
(self.webpackChunkventriloc = self.webpackChunkventriloc || []).push([
    ["vendors-node_modules_swiper_swiper_esm_js"], {
        "./node_modules/swiper/swiper.esm.js": (e, t, s) => {
            function i(e) {
                ...
                for (let s = 1; s < arguments.length; s += 1) {
                    ...
                    if (null != i && !T(i)) {
                        ...
                        for (let t = 0, n = s.length; t < n; t += 1) {
                            ...
                            void 0 !== r && r.enumerable && (C(e[n]) && C(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : S(e[n], i[n]) : !C(e[n]) && C(i[n]) ? (e[n] = {}, i[n].__swiper__ ? e[n] = i[n] : S(e[n], i[n])) : e[n] = i[n])
                        }
                    }
                }
                return e
            ...
            function P(e) {
                return void 0 === e && (e = {}), M || (M = function(e) {
                    ...
                    const u = r.match(/(iPod)(.*OS\s([\d_]+))?/),
                        ...
                        f = "Win32" === n;
                    let m = "MacIntel" === n;
                    return !p && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (p = r.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), m = !1), c && !f && (a.os = "android", a.android = !0), (p || h || u) && (a.os = "ios", a.ios = !0), a
                }(e)), M
            }
            ...
            const A = {
                ...
                updateSlides: function() {
                    ...
                    for (let n = 0; n < p; n += 1) {
                        ...
                        if (E && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display")) {
                            if ("auto" === i.slidesPerView) {
                                ...
                                if (l && (a[0].style.transform = "none"), o && (a[0].style.webkitTransform = "none"), i.roundLengths) y = e.isHorizontal() ? a.outerWidth(!0) : a.outerHeight(!0);
                                else {
                                    const e = s(r, "width"),
                                        t = s(r, "padding-left"),
                                        i = s(r, "padding-right"),
                                ...
                                l && (a[0].style.transform = l), o && (a[0].style.webkitTransform = o), i.roundLengths && (y = Math.floor(y))
                            } else y = (r - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (y = Math.floor(y)), c[n] && (c[n].style[t("width")] = `${y}px`);
                            c[n] && (c[n].swiperSlideSize = y), f.push(y), i.centeredSlides ? (C = C + y / 2 + T / 2 + b, 0 === T && 0 !== n && (C = C - r / 2 - b), 0 === n && (C = C - r / 2 - b), Math.abs(C) < .001 && (C = 0), i.roundLengths && (C = Math.floor(C)), S % i.slidesPerGroup == 0 && u.push(C), h.push(C)) : (i.roundLengths && (C = Math.floor(C)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(C), h.push(C), C = C + y + b), e.virtualSize += y + b, T = y, S += 1
                        }
                    }
                    if (e.virtualSize = Math.max(e.virtualSize, r) + g, a && l && ("slide" === i.effect || "coverflow" === i.effect) && n.css({
                        ...
                        }), E && e.grid.updateWrapperSize(y, u, t), !i.centeredSlides) {
                        const t = [];
                    ...
                    if (Object.assign(e, {
                        ...
                        x(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"), x(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
            ...
            function B(e) {
                ...
                if (Object.assign(n, {
                        ...
                        isScrolling: void 0,
                        startMoving: void 0
                    }), l.startX = f, l.startY = m, n.touchStartTime = w(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== c.type) {
                    let e = !0;
            ...
            function _(e) {
                ...
                if (c > i.longSwipesMs) {
                    ...
                    "next" === t.swipeDirection && (g >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? f : u + b) : t.slideTo(u)), "prev" === t.swipeDirection && (g > 1 - i.longSwipesRatio ? t.slideTo(u + b) : null !== m && g < 0 && Math.abs(g) > i.longSwipesRatio ? t.slideTo(m) : t.slideTo(u))
                } else {
                    if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
                    t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl) ? o.target === t.navigation.nextEl ? t.slideTo(u + b) : t.slideTo(u) : ("next" === t.swipeDirection && t.slideTo(null !== f ? f : u + b), "prev" === t.swipeDirection && t.slideTo(null !== m ? m : u))
                }
            }
            ...
            const q = (e, t) => {
                ...
                (i.preventClicks || i.preventClicksPropagation) && r[p]("click", e.onClick, !0), i.cssMode && l[p]("scroll", e.onScroll), i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", H, !0) : e[u]("observerUpdate", H, !0)
            };
            const R = {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = B.bind(e), e.onTouchMove = N.bind(e), e.onTouchEnd = _.bind(e), s.cssMode && (e.onScroll = j.bind(e)), e.onClick = F.bind(e), i.touch && !V && (t.addEventListener("touchstart", W), V = !0), q(e, "on")
                    },
            ...
            class ee {
                constructor() {
                    ...
                    const r = this;
                    r.__swiper__ = !0, r.support = k(), r.device = P({
...
//# sourceMappingURL=vendors-node_modules_swiper_swiper_esm_js.118661ab34464d54dd16.bundle.js.map