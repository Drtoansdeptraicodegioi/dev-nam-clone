        ...
        function() {
            ...
            var st = function(t, e, n, r) {
                    if ("length" !== n && "prototype" !== n && "arguments" !== n && "caller" !== n) {
                        ...
                        !ft(o, i) && r || Object.defineProperty(t, n, i)
                    }
                },
                ft = function(t, e) {
                ...
                vt = Object.getOwnPropertyDescriptor(Function.prototype, "toString"),
                gt = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"),
                ht = function(t, e, n) {
                    var r = "" === n ? "" : "with ".concat(n.trim(), "() "),
                        o = pt.bind(null, r, e.toString());
                    Object.defineProperty(o, "name", gt), Object.defineProperty(t, "toString", lt(lt({}, vt), {}, {
                        value: o
                    }))
                };
            ...
            function xt(t) {
                return function(t, e) {
                    ...
                    for (r = 0; r < d; r++)
                        ...
                        if ((i = t[r]).keys)
                            for (n = e[f], o = 0; o < i.keys.length; o++) {
                                if (null == n) throw new Error(xt('[sprintf] Cannot access property "%s" of undefined value "%s"', i.keys[o], i.keys[o - 1]));
                                n = n[i.keys[o]]
                            } else n = i.param_no ? e[i.param_no] : e[f++];
                        if (Et.not_type.test(i.type) && Et.not_primitive.test(i.type) && n instanceof Function && (n = n()), Et.numeric_arg.test(i.type) && "number" != typeof n && isNaN(n)) throw new TypeError(xt("[sprintf] expecting number but found %T", n));
                        switch (Et.number.test(i.type) && (l = n >= 0), i.type) {
                            case "b":
                        ...
                        Et.json.test(i.type) ? p += n : (!Et.number.test(i.type) || l && !i.sign ? s = "" : (s = l ? "+" : "-", n = n.toString().replace(Et.sign, "")), a = i.pad_char ? "0" === i.pad_char ? "0" : i.pad_char.charAt(1) : " ", u = i.width - (s + n).length, c = i.width && u > 0 ? a.repeat(u) : "", p += i.align ? s + n + c : "0" === a ? s + c + n : c + s + n)
                    }
                    return p
                }(function(t) {
                    if (At[t]) return At[t];
                    var e, n = t,
                        ...
                        o = 0;
                    for (; n;) {
                        if (null !== (e = Et.text.exec(n))) r.push(e[0]);
                        else if (null !== (e = Et.modulo.exec(n))) r.push("%");
                        else {
                            if (null === (e = Et.placeholder.exec(n))) throw new SyntaxError("[sprintf] unexpected placeholder");
                            if (e[2]) {
                                o |= 1;
                                var i = [],
                                    c = e[2],
                                    a = [];
                                if (null === (a = Et.key.exec(c))) throw new SyntaxError("[sprintf] failed to parse named argument key");
                                for (i.push(a[1]);
                                    "" !== (c = c.substring(a[0].length));)
                                    if (null !== (a = Et.key_access.exec(c))) i.push(a[1]);
                                    else {
                                        if (null === (a = Et.index_access.exec(c))) throw new SyntaxError("[sprintf] failed to parse named argument key");
                                        i.push(a[1])
                                    }
                                e[2] = i
                            } else o |= 2;
            ...
            function Tt(t, e) {
                return xt.apply(null, [t].concat(e || []))
            }
            ...
            var Lt = function() {
                ...
                It = /(android)/i.test(window.navigator.userAgent),
                Mt = !!window.chrome,
                Dt = "undefined" != typeof InstallTrigger,
                Ft = document.documentMode || !1,
                Nt = !Ft && !!window.StyleMedia,
                Ht = !!window.navigator.userAgent.match(/(iPod|iPhone|iPad)/i),
                qt = !!window.navigator.userAgent.match(/(iPod|iPhone)/i),
                zt = !!window.opera || window.navigator.userAgent.indexOf(" OPR/") >= 0,
                Jt = Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0 || !Mt && !zt && "undefined" !== window.webkitAudioContext,
                Rt = window.navigator.platform;
            ...
            var Bt = 0,
                ...
                $t = function() {
                    ...
                    Bt = e.scrollTop, n.overflowY = "scroll", n.position = "fixed", n.width = "100%", t && (n.marginTop = "-".concat(Bt, "px"))
                },
                Yt = function() {
                    var t = Xt(),
                        e = document.body.style;
                    e.overflowY = "", e.position = "static", e.marginTop = "0px", e.width = "", t.scrollTop = Bt
                };
            ...
            function Vt(t) {
                ...
                t.addEventListener("mousedown", (function(n) {
                    ...
                    e.isDown = !1, t.classList.remove("drag-horizontal--active"), Gt({
                    ...
                    if (e.isDown) {
                        ...
                        t.scrollLeft = e.scrollLeft - r, e.moveEventTriggered || (Gt({
            ...
            function re() {
                var t = ne(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", !1, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document, arguments.length > 2 && void 0 !== arguments[2] && arguments[2]);
            ...
            var me = function(t) {
                    ...
                    n.instances && t && ne("[data-simplebar]", !0, t, !0).forEach((function(t) {
                        var e;
                ...
                je = function(t) {
                    be[t].up && (window.cancelAnimationFrame(be[t].up), be[t].up = null), be[t].down && (window.cancelAnimationFrame(be[t].down), be[t].down = null)
                },
                Se = function(t, e) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 400,
                        ...
                        i = ee(t),
                        c = null;
                    t.style.maxHeight = "0", Oe(e), je(e);
                    var a = function a(u) {
                        c || (c = u);
                        var l = u - c,
                            s = we(l / n) * (i - o) + o;
                        t.style.maxHeight = "".concat(s, "px"), l < n ? be[e].down = window.requestAnimationFrame(a) : (be[e].down = null, t.style.maxHeight = "none", r && r())
                    };
                    setTimeout((function() {
                        be[e].down = window.requestAnimationFrame(a)
                    }), ye)
                },
                Ee = function(t, e) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 400,
                        ...
                        o = t.offsetHeight,
                        i = null;
                    t.style.maxHeight = "".concat(o, "px"), Oe(e), je(e);
                    var c = function c(a) {
                        i || (i = a);
                        var u = a - i,
                            l = we(u / n) * (0 - o) + o;
                        t.style.maxHeight = "".concat(l, "px"), u < n ? be[e].up = window.requestAnimationFrame(c) : (be[e].up = null, t.style.maxHeight = "0", r && r())
                    };
                    setTimeout((function() {
                        be[e].up = window.requestAnimationFrame(c)
                    }), ye)
                };
            ...
            function ke() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                    ...
                    n = {};
                return !t || "string" != typeof t && "number" != typeof t && !Array.isArray(t) && ("object" !== D(t) || Array.isArray(t)) || Array.isArray(t) && !t.length ? n : (n[e] = !0, "string" == typeof t || "number" == typeof t || Array.isArray(t) ? Te(Te({}, n), Ae(t, "", e)) : ["", "md", "lg"].reduce((function(n, r) {
                    return Object.prototype.hasOwnProperty.call(t, r) ? Te(Te({}, n), Ae(t[r], r ? "".concat(r, "-") : "", e)) : n
                }), n))
            }
            var Ce = function() {
            ...
            function Ie(t) {
                ...
                return mt(p, t), p.cancel = function() {
            ...
            if ("undefined" != typeof Element && !Element.prototype.matches) {
                ...
                De.matches = De.matchesSelector || De.mozMatchesSelector || De.msMatchesSelector || De.oMatchesSelector || De.webkitMatchesSelector
            }

            function Fe(t, e, n, r, o) {
                var i = Ne.apply(this, arguments);
            ...
            var He = function(t, e, n, r) {
                ...
                return "function" == typeof t.addEventListener ? Fe.apply(null, arguments) : "function" == typeof n ? Fe.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)), Array.prototype.map.call(t, (function(t) {
                    return Fe(t, e, n, r, o)
                })))
            };
            ...
            function ze() {
                ...
                !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2] ? window.addEventListener("resize", Ie(t, {
                    wait: e
                })) : window.removeEventListener("resize", Ie(t, {
                    wait: e
                }))
            }
            ...
            var Ze;
            Ze = window.gform.utils, Object.entries(l).forEach((function(t) {
                var e = f(t, 2),
                    n = e[0],
                    r = e[1];
                Ze[n] = r
